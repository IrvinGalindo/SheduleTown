 ...
 */
public class AdapterItemPrefect extends BaseAdapter {
    protected Activity activity;
    protected ArrayList<PrefectList> items;
    protected PrefectList prefectList;
    protected int nvaPos=0;

    public AdapterItemPrefect(Activity activity, ArrayList<PrefectList> items) {
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        if (convertView==null)
        {
            ...
            view=inflater.inflate(R.layout.list_view_prefect,null);
        }
